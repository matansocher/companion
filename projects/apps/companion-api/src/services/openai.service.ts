import type { ChatContext, Message } from '@companion/shared';
...
export class OpenAIService {
   ...
   */
  async chat(userMessage: string, context?: ChatContext, conversationHistory: Message[] = []): Promise<Message> {
   ...
   */
  private buildMessages(userMessage: string, context?: ChatContext, conversationHistory: Message[] = []): OpenAIMessage[] {
